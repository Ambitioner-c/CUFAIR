...
def parse_args():
    parser = argparse.ArgumentParser(description='Our Model without Source Credibility for Situation 2')
    parser.add_argument('--task_name', nargs='?', default='OM_wo_SC4Situation2',
                        help='Task name')
    ...
    parser.add_argument('--fold', type=int, default=1,
                        help='Fold')
    parser.add_argument('--finetuned_model_path', nargs='?', default='./FinetunedModel/OM_wo_SC-20241101_144541/best_model.pth',
