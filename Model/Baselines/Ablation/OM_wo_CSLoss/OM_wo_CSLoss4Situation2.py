...
def parse_args():
    parser = argparse.ArgumentParser(description='Our Model w/o Community Support Loss for Situation 2')
    parser.add_argument('--task_name', nargs='?', default='OM_wo_CSLoss4Situation2',
                        help='Task name')
    ...
    parser.add_argument('--finetuned_model_path', nargs='?', default='./FinetunedModel/OM-20241031_164807/best_model.pth',
