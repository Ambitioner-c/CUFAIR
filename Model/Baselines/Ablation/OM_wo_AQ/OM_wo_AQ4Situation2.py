...
def parse_args():
    parser = argparse.ArgumentParser(description='Our Model without Argument Quality for Situation 2')
    parser.add_argument('--task_name', nargs='?', default='OM_wo_AQ4Situation2',
                        help='Task name')
    ...
    parser.add_argument('--finetuned_model_path', nargs='?', default='./FinetunedModel/OM_wo_AQ-20241101_152758/best_model.pth',
