...
class OurModel(nn.Module):
    ...
    def forward(self, inputs: dict):
        ...
        # SC
        source_credibility = self.sqalstm(bert_output_rel_left.unsqueeze(1), bert_output_right.unsqueeze(1), bert_output_comment)[:, -1, :]     # torch.Size([batch_size, hidden_size])
...
def parse_args():
    parser = argparse.ArgumentParser(description='Our Model without Community Interaction for Situation 2')
    parser.add_argument('--task_name', nargs='?', default='OM_wo_CI4Situation2',
                        help='Task name')
    ...
    parser.add_argument('--finetuned_model_path', nargs='?', default='./FinetunedModel/OM_wo_CI-20241101_185037/best_model.pth',
