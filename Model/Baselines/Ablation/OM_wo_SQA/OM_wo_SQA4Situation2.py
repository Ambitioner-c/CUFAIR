...
from Model.LSTM.CILSTM import CILSTMModel
...
class OurModel(nn.Module):
    ...
    def forward(self, inputs: dict):
        ...
        # SC
        source_credibility = self.cilstm(bert_output_comment, ping)[:, -1, :]                                       # torch.Size([batch_size, hidden_size])
...
def parse_args():
    parser = argparse.ArgumentParser(description='Our Model without Sustained Question and Answer for Situation 2')
    parser.add_argument('--task_name', nargs='?', default='OM_wo_SQA4Situation2',
                        help='Task name')
    ...
    parser.add_argument('--finetuned_model_path', nargs='?', default='./FinetunedModel/OM_wo_SQA-20241101_185124/best_model.pth',
