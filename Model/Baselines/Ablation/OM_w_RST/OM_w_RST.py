...
class OurModel(nn.Module):
    def __init__(
        ...
        # TODO change SACILSTMModel to SQACILSTMModel
...
def parse_args():
    parser = argparse.ArgumentParser(description='Our Model with RST Pretraining')
    parser.add_argument('--task_name', nargs='?', default='OM_w_RST',
                        help='Task name')
