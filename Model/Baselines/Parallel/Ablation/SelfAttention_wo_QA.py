...
class OurModel(nn.Module):
    ...
    def forward(self, inputs: dict):
        ...
        # SC
        source_credibility = self.self_attention_layer(bert_output_comment)[0]                      # torch.Size([batch_size, max_sequence_length, hidden_size])
...
def parse_args():
    parser = argparse.ArgumentParser(description='Self-Attention w/o QA Model')
    parser.add_argument('--task_name', nargs='?', default='SelfAttention_wo_QA',
                        help='Task name')
