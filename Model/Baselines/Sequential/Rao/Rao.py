...
class RaoModel(nn.Module):
    ...
    def forward(self, inputs: dict):
        ...
        source_credibility = self.lstm_sentence(o_r)[:, -1, :]                                      # torch.Size([batch_size, 64])
...
def parse_args():
    parser = argparse.ArgumentParser(description='Rao Model')
    parser.add_argument('--task_name', nargs='?', default='Rao',
                        help='Task name')
