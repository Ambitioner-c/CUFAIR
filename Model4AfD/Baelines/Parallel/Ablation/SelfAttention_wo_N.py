...
class OurModel(nn.Module):
    def __init__(
        ...
        self.credibility_layer = nn.Linear(hidden_size * 10, hidden_size)
    ...
    def forward(self, inputs: dict):
        ...
        # Consensus
        source_credibility = self.self_attention_layer(bert_output_comment)[0]                      # torch.Size([batch_size, seq_length, hidden_size])
...
def parse_args():
    parser = argparse.ArgumentParser(description='Self-Attention w/o N Model')
    parser.add_argument('--task_name', nargs='?', default='SelfAttention_wo_N',
                        help='Task name')
