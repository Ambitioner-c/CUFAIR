...
from Model.LSTM.GRU import GRUModel
...
def parse_args():
    parser = argparse.ArgumentParser(description='GRU w N Model')
    parser.add_argument('--task_name', nargs='?', default='GRU_w_N',
                        help='Task name')
